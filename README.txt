HOW TO COMPILE AND RUN THE APPLICATION
	...
	2. At the prompt window, go to the new project path root and write the command: mvn eclipse:eclipse
...
HOW TO TEST THE WEBSERVICE METHODS
	1. PRODUCTS
		1.1 List product catalog
			1.1.1 If your web server is started, access in your browser the url http://localhost:8080/java-webapp-coding-test/rest/produto/list
			1.1.2 The list (in Json format) must be displayed on the page
		1.2 Read a single product by its id
			1.2.1 If your web server is started, access in your browser the url http://localhost:8080/java-webapp-coding-test/rest/produto/detail/{ID_PRODUCT},
	...
	2. ORDERS
		2.1 Place an order
			2.1.1 Open the file StartPlaceOrder.java in Eclipse
		...
		2.2 Modify an existing order
			2.1.1 Open the file StartModifyOrder.java in Eclipse
			2.1.2 Change the values of the constants by the values of your selected Order to modify.
			2.1.3 For a better test, choose an ID that exists in the database (table TB_ORDEM)
...
HOW TO RUN THE AUTOMATED TESTS
	1. TestOrdemService
		1.1 Open the file TestOrdemService.java in Eclipse
	...
	2. TestProdutoService
		1.1 Open the file TestProdutoService.java in Eclipse
...
ADDITIONAL COMMENTS
	...
	2. For any doubts, please email me at daniloalvim@gmail.com